            ...
            <div style={{ padding: "20px 24px" }}>
                ...
                <div style={{ ...S.cardSubtle, marginBottom: 20 }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(130px, 1fr))", gap: 12 }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 3 }}>
                            <label style={{ ...S.fieldLabel, color: "#a855f7", opacity: 0.8 }}>kA (accel)</label>
                            <input type="number" value={ka} step={0.0001} onChange={e => { const v = parseFloat(e.target.value); if (!isNaN(v)) setKa(v); }} style={{ ...S.inputWide, borderColor: "#a855f733", color: "#a855f7" }} />
